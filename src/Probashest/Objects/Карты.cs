...
namespace IIS.Probashest
{
    ...
    public class Карты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probashest.ВидКарты fТипКарты;
        ...
        public virtual IIS.Probashest.ВидКарты ТипКарты
        {
            get
            {
                ...
                IIS.Probashest.ВидКарты result = this.fТипКарты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КартыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартыE", typeof(IIS.Probashest.Карты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КартыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартыL", typeof(IIS.Probashest.Карты));
                }
            }
        }
    }
